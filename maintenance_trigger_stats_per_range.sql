...
select
	...
	, case when end_odometer between 0 and 499.99 then '0 Less Than 500'
			when end_odometer between 500 and 1099.99 then '1 Less Than 500'
			...
			when end_odometer between 2200 and 2749.99 then '4  Between 2,200 and 2750'
			when end_odometer between 2750 and 3300 then '5 More Than 2750'
...
from 
	...
	from 
		updated_data
	where ride_triggered_maintenance = 'FALSE'
	group by 1
	order by 1
	) b 
